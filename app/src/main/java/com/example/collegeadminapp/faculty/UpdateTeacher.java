...
public class UpdateTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTeacherImage=(ImageView)findViewById(R.id.updateTeacherImage);
        updateTeacherName=(EditText)findViewById(R.id.updateTeacherName);
        updateTeacherEmail=(EditText)findViewById(R.id.updateTeacherEmail);
        updateTeacherPost=(EditText)findViewById(R.id.updateTeacherPost);
        updateTeacherButton=(Button)findViewById(R.id.updateTeacherButton);
        deleteTeacherButton=(Button)findViewById(R.id.deleteTeacherButton);
    ...
    private void uploadImage() {
        ...
        final StorageReference filePath=storageReference.child(finalImage+"jpeg");
    ...
    private void updateData(String s) {
        ...
        databaseReference.child(category).child(uniqueKey).updateChildren(hm).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                pd.dismiss();
                Toast.makeText(UpdateTeacher.this, "Faculty Data update Successfully!!", Toast.LENGTH_SHORT).show();
        ...
        databaseReference.child(category).child(uniqueKey).removeValue()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        pd.dismiss();
                        Toast.makeText(UpdateTeacher.this,"Faculty data Deleted Successfully",Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(UpdateTeacher.this,UpdateFaculty.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                    }
